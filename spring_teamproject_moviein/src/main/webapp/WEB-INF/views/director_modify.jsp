		...
		<div class="contents">
			<div class="container">
				<div class="writrerbox">
					<form action="director_modifydata" method="post" id="insertBoardFrm"
						...
						<table>
							...
							<tr>
							<td><input type="hidden" name="dAI_Id" value="${director_view.dAI_Id}">
							<input type="hidden" name="dAI_Id" value="${director_view.dAI_Id}">
								<input type="text" name="dAI_Title" size="144"
									placeholder="" value="${director_view.dAI_Title}" required></td>
							</tr>
							<tr>
								<th>내용</th>
							</tr>
							<tr>
								<td><textarea rows="20" cols="103" name="dAI_Content"
										id="contents" placeholder="내용 입력" required>
					...
					<!-- 	<input type="file" name="safeFile" />
						<input type="file" name="safeFile2" /> -->
							...
							<input type="button" value="취소" onclick="location.href='people_list'">
						</div>
					</form>
				</div>
			</div>
