		...
		<div class="contents">
			<div class="container">
				<div class="writrerbox">
					<form action="recommend_modifydata" method="post" id="insertBoardFrm"
						...
						<table>
							...
							<tr>
							<td><input type="hidden" name="dAI_Id" value="${recommend_view.dAI_Id}">
								<input type="text" name="dAI_Title" size="144"
									placeholder="" value="${recommend_view.dAI_Title}" required></td>
							</tr>
							<tr>
								<th>내용</th>
							</tr>
